...
const Mock2 = () => {
  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-gradient-to-r from-pink-500 via-purple-500 to-blue-600 flex justify-center items-center">
        <form className="p-[2rem] border-slate-700 border-2 bg-white bg-opacity-90 rounded-lg" onSubmit={handlesubmit}>
          <div className="flex justify-center p-5">
            <FaBook className="text-4xl flex text-green-800 animate-bounce" />
            <p className="text-4xl text-black text-ellipsis p-2 justify-center flex w-full">Book Registry </p>
          </div>
          <p className="text-lg text-black text-ellipsis p-2">Book Name</p>
          <input
            onChange={handlebookchange}
            className="p-3 rounded-xl border w-[15rem] "
            type="text"
            name="bookname"
          ...
          <div className="p-5 justify-center flex">
            <button className="py-2 px-5 bg-pink-700 border rounded-xl hover:scale-110 w-cover text-xl text-white">
              Add Data
            </button>
          </div>
        </form>
